...
with tab1:
    ...
    fig.update_layout(
        **{k: v for k, v in PL.items() if k != "legend"},
        legend=dict(orientation="h", y=1.08),
        height=420, barmode="relative",
        margin=dict(t=30, b=50, l=60, r=60),
        yaxis=dict(title="$ ARS MM", gridcolor="#252f45", zeroline=False, color="#c5cdd8"),
        yaxis2=dict(title="Acumulado $ ARS MM", gridcolor="#252f45", zeroline=False,
                    overlaying="y", side="right", color="#c5cdd8"),
    ...
    fig_e.update_layout(**{**PL, "legend": dict(orientation="h", y=1.08)}, height=380, barmode="stack", margin=dict(t=30, b=50, l=60, r=20))
