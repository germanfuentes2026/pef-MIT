...
def run_model(
    ...
    # Base imponible = Ingresos – Gastos – Amortización – Intereses deducibles
    # Ingresos sin IVA escalan con tráfico y tarifa
    ingresos_iigg = INGRESOS_IIGG_BASE * factor
    gastos_iigg   = (opex / (1 + 0.15)) + GARANTIAS  # OPEX sin IVA de C&M (15%) + Garantías
    base_imponible = ingresos_iigg - gastos_iigg - AMORT_IMP_BASE - INT_DEDUCIBLES_BASE
